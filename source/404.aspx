...
<body>
    <form id="form1" runat="server">
        <div class="orta">
             <img src="Adsız.png" class="auto-style1"/>
        <p></p>
        </div>
        ...
        <div class="labeldiv">
            ...
            <br />
            <br />
            <asp:Label ID="Label2" runat="server" ForeColor="White" Text="Size sunduğumuz servisde aksaklık yaşattığımız için özür dileriz. Var olmayan bir sayfaya uğradınız veya ArtadoSearch kısa süreli bir çöküntü yaşadı. Eğer ikinci şık ise şu anda bu sorun ile ilgileniyoruzdur. Sizde bu sorunu şimdilik gidermek için şunları yapabilirsiniz:" Font-Bold="true" Font-Size="Larger" ></asp:Label>
            <br />
            <br />
