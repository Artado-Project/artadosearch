    ...
    <form id="form1" runat="server">
        <div class="middle">
            ...
            <div id="product_details" runat="server" class="product_page">
                ...
                <asp:Label ID="nametxt" runat="server" Text="Name" CssClass="p_name"></asp:Label><br /><br />
                <a id="dev_a" runat="server"><asp:Label ID="devtxt" runat="server" Text="Developer" CssClass="p_dev"></asp:Label></a>
                <a id="a_use" runat="server" class="use btn"><asp:Label ID="Label1" runat="server" Text="Use"></asp:Label></a><br />
                <div class="slider">
                ...
                <a id="source_a" runat="server" class="btn btn-outline-success mb-3"><asp:Label ID="sourcetxt" runat="server" Text="Source Code"></asp:Label></a>
