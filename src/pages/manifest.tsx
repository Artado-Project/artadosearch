    ...
    return (
        <>
            <div className={'Artado-container'} style={{ lineHeight: '25px' }}>
                <h1 className="manifest-title">Artado Manifest </h1>
                <Button type="default" size={'small'} href={'/'}>Back to Home</Button>
                <br />
                <br />
                ...
                <br /><br />
                <h2 className="manifest-subtitle">Why do we care so much about a free internet?</h2>
                ...
                <br /><br/>
                <h2 className="manifest-subtitle">Why you should not pay for search?</h2>
                Search engines are the most used websites on the internet. They are the first step to accessing the internet. Therefore, search engines should be free and accessible to everyone. Search engines should not be a tool for profit. Search engines should be a tool for the people.
                <br /><br />
                Charging people a price for access to accurate information is anathema to democracy. Turning search engines into a revenue stream and charging money for accurate information or otherwise throwing them into misleading information pollution (advertisements) is treason in the Internet country. We think that we should direct all people to the right information, especially in this period of information pollution, and that this is a human duty, and we defend this idea in a widespread way.
                <br /><br />
                <h2 className='manifest-subtitle'>Embracing anti-censorship</h2>
                Suppression of information is a mechanism employed by authoritarian regimes to curtail the unfettered exploration of ideas and perspectives. It becomes a favored tool for those who harbor apprehensions about confronting the unfiltered reality, aiming to shield certain narratives from public scrutiny. This tactic is often wielded by individuals or entities with an inclination to withhold the complete truth, thereby fostering an environment where transparency and open discourse are sacrificed in favor of a controlled narrative.
                <br /><br />
                The internet should be accessible to everyone, without restrictions from any power or authority. Accessing the wealth of information on the internet is a fundamental right. We advocate for an internet where everyone can engage in free information exchange, where personal data is respected, and where ideas can be expressed without censorship.
                <br /><br />
                <h2 className="manifest-subtitle">Anonymity</h2>
                ...
                <br /><br />
                <h2 className="manifest-subtitle">Right to Privacy</h2>
                ...
                <br /><br />
                <h2 className="manifest-subtitle">Making the Internet a Better Place</h2>
